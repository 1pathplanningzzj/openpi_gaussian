...
CHECKPOINT_BASE_DIR="${CHECKPOINT_BASE_DIR:-/data/zijianzhang/train_ckpts}"
EXP_NAME="${EXP_NAME:-gs_vla_${PRESET}}"
LOG_DIR="${LOG_DIR:-$CHECKPOINT_BASE_DIR/logs/libero_ablation}"
LOG_FILE="${LOG_FILE:-$LOG_DIR/${EXP_NAME}.log}"

mkdir -p "$LOG_DIR"

export HF_HOME="${HF_HOME:-/data/zijianzhang/.cache/huggingface}"
export HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-/data/zijianzhang/.cache/huggingface/datasets}"
export TRANSFORMERS_CACHE="${TRANSFORMERS_CACHE:-/data/zijianzhang/.cache/huggingface/transformers}"
