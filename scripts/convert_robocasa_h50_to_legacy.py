...
The current openpi workspace pins an older lerobot stack that expects:
- meta/tasks.jsonl
- meta/episodes.jsonl
...
Example:
  ./uv_venv/bin/python scripts/convert_robocasa_h50_to_legacy.py \
      --dataset-root /data/zijianzhang/robocasa-H50-with-depth \
      --output-root /data/zijianzhang/robocasa-H50-legacy \
      --overwrite
"""
