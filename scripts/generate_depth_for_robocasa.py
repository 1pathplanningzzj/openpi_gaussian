...
Example:
  ./uv_venv/bin/python scripts/generate_depth_for_robocasa.py \
      --dataset-root /data/zijianzhang/robocasa-H50 \
      --output-root /data/zijianzhang/robocasa-H50-with-depth \
      --device cuda
"""
