...
def _install_ablation_runtime_patches() -> None:
    ...
    if getattr(PI0Pytorch, "_libero_ablation_runtime_patched", False):
        return

    original_compute = PI0Pytorch._compute_gaussian_supervision_loss
    ...
    PI0Pytorch._compute_gaussian_supervision_loss = patched_compute
    PI0Pytorch._libero_ablation_runtime_patched = True
