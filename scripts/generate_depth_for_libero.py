...
Usage:
    python scripts/generate_depth_for_libero.py \
        ...
        --output_dir /data/zijianzhang/LIBERA/data_with_depth \
        --model_size small \
        --batch_size 8 \
        --num_workers 4
"""
...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='/data/zijianzhang/LIBERA/data',
                       help='Path to LIBERO data directory')
    parser.add_argument('--output_dir', type=str, default='/data/zijianzhang/LIBERA/data_with_depth',
