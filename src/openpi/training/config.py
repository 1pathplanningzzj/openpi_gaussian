...
class TrainConfig:
    ...
    stage4_render_weight: float = 0.1
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(
            ...
            use_future_depth_aux=True,
            future_depth_aux_loss_weight=0.02,
            future_depth_aux_downsample=2,
            velocity_world_model_scale=4.0,
            num_motion_slots=8,
            slot_assignment_temperature=0.5,
            slot_translation_scale=4.0,
            slot_rotation_scale=0.5,
            slot_entropy_loss_weight=1e-3,
            slot_balance_loss_weight=5e-2,
            slot_transform_reg_weight=1e-3,
