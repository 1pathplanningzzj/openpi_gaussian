...
# Default parameters
CONFIG_PATH='configs/nuscenes/df3dgs_inference.yaml'
CHECKPOINT_PATH='/workspace/kuntaoxiao/projects/AD-FFgsStudio/best_module-v3.ckpt'
OUTPUT_DIR='./work_dirs/df3dgs_MF_1114_12hz'
DEVICE='0'  #CUDA_VISIBLE_DEVICES=7
# MAX_SCENES="2"
MULTI_GPU_FLAG=""
DEBUG_MODE=false

NOVEL_VIEW_DISTANCES="1.0,2.0,3.0"
# EVAL_RESOLUTION="280x518"  # "original" for 280x518, "upsampled" for 900x1600
...
python scripts/df3dgs_inference.py "${CMD_ARGS[@]}"
