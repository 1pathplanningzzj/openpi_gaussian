...
class NuScenesSceneDataset(Dataset):
    ...
    def __init__(self, path, stage,
        ...
        self.path = path
        self.cache_dir = '/mnt/data_storage/kuntaoxiao/md-dit/nuscenes'
        self.stage = stage
        self.dataset_idx = 0
        ...
        for scene_samples in self.scenes_data:
            self.cumulative_lengths.append(self.cumulative_lengths[-1] + len(scene_samples)//self.sample_rate)
    ...
    def get_scene_sample(self, scene_idx, sample_idx):
        ...
        sample_token = self.scenes_data[scene_idx][sample_idx]
        sample_nusc = self.dataset.get('sample', sample_token)
    ...
    def __getitem__(self, idx):
        ...
        sample_idx = (idx - self.cumulative_lengths[scene_idx])*self.sample_rate
