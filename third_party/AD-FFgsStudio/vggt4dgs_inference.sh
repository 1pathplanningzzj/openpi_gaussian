...
# Default parameters
CONFIG_PATH='configs/nuscenes/vggt4dgs_inference.yaml'
CHECKPOINT_PATH='/workspace/kuntaoxiao/projects/AD-FFgsStudio/work_dirs/ckpts/vggt4dgs/test2_stage2/ckpt/best_module-v2.ckpt'
OUTPUT_DIR='/workspace/kuntaoxiao/projects/AD-FFgsStudio/work_dirs/vggt4dgs_1221_12hz'
DEVICE='0'
# MAX_SCENES="2"
MULTI_GPU_FLAG=""
DEBUG_MODE=false
...
echo "python -m scripts.vggt4dgs_inference ${CMD_ARGS[@]}"
echo ""
...
python scripts/vggt4dgs_inference.py "${CMD_ARGS[@]}"
