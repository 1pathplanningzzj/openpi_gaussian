...
class DF3DGSModel(torch.nn.Module):
    ...
    def load_official_weights(self,device='cuda:0'):
        ...
        depth_weight_path = f'/workspace/kuntaoxiao/projects/AD-FFgsStudio/weights_{self.novel_view_mode}/depth_net.pth'
        gaussian_weight_path = f'/workspace/kuntaoxiao/projects/AD-FFgsStudio/weights_{self.novel_view_mode}/gs_net.pth'

        # depth_weight_path = f'/workspace/kuntaoxiao/projects/AD-FFgsStudio/weights_MF/depth_net.pth'
        # gaussian_weight_path = f'/workspace/kuntaoxiao/projects/AD-FFgsStudio/weights_MF/gs_net.pth'
