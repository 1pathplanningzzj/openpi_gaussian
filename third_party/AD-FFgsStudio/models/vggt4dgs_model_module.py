...
if __name__=='__main__':
    ...
    # restore_ckpt = '/workspace/kuntaoxiao/ckpts/AD-FFgsStduio/vggt4dgs/test1/ckpt/vggt4dgs_1024-v2.ckpt'
    # restore_ckpt = '/workspace/kuntaoxiao/datas/results/AD-FFgsStduio/vggt4dgs/test1/ckpt/restore_stage1-v2.ckpt'
    # restore_ckpt = 'restore_stage1.ckpt'
    restore_ckpt = '/workspace/kuntaoxiao/projects/AD-FFgsStudio/work_dirs/ckpts/vggt4dgs/test1/ckpt/restore_stage1-v3.ckpt'
    stage1_ckpt = torch.load(restore_ckpt,map_location=f"cuda:0")

    # stage2_ckpt = '/workspace/kuntaoxiao/datas/results/AD-FFgsStduio/vggt4dgs/test2_stage2/ckpt/best_module.ckpt'
