...
CUDA_VISIBLE_DEVICES=7 nohup uv run --active scripts/train_pytorch.py pi05_libero --checkpoint-base-dir=/data/zijianzhang/train_ckpts --exp-name=gaussian_world_model_exp0217 --overwrite > training_exp0217.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup uv_venv/bin/torchrun \
    ...
    --exp_name gaussian_world_model_exp0221 \
    --checkpoint_base_dir /data/zijianzhang/train_ckpts > training_exp0221_ddp.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup uv_venv/bin/torchrun \
    ...
    --exp_name gaussian_world_model_exp0221 \
    --checkpoint_base_dir /data/zijianzhang/train_ckpts \
    --resume > training_exp0221_ddp.log 2>&1 &